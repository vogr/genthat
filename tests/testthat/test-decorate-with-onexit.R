...
test_that("decorate_with_onexit decorates a package function", {
    capture <- list()
...
test_that("decorate_with_onexit does not introduce any extra frames", {
    capture <- list()
